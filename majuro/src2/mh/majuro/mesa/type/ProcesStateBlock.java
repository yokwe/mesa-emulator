...
public final class ProcesStateBlock {
    ...
    public static final class link {
        ...
        public static @CARD16 int get(@LONG_POINTER int base) {
            return RecordBase.get(ProcesStateBlock.link::offset, base);
        }
        public static void set(@LONG_POINTER int base, @CARD16 int newValue) {
            RecordBase.set(ProcesStateBlock.link::offset, base, newValue);
        }
    }
    ...
    public static final class flags {
        ...
        public static @CARD16 int get(@LONG_POINTER int base) {
            return RecordBase.get(ProcesStateBlock.flags::offset, base);
        }
        public static void set(@LONG_POINTER int base, @CARD16 int newValue) {
            RecordBase.set(ProcesStateBlock.flags::offset, base, newValue);
        }
    }
    ...
    public static final class conext {
        ...
        public static @CARD16 int get(@LONG_POINTER int base) {
            return RecordBase.get(ProcesStateBlock.conext::offset, base);
        }
        public static void set(@LONG_POINTER int base, @CARD16 int newValue) {
            RecordBase.set(ProcesStateBlock.conext::offset, base, newValue);
        }
    }
