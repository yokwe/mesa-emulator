...
# Input
HEADERS += BCD.h   BCDFile.h   BTIndex.h   CTXIndex.h   HTIndex.h   MDIndex.h   SEIndex.h   Symbols.h
SOURCES += BCD.cpp BCDFile.cpp BTIndex.cpp CTXIndex.cpp HTIndex.cpp MDIndex.cpp SEIndex.cpp Symbols.cpp
